    ...
    <table class="table">
      <tbody>
        ...
        <tr>
          ...
          <td><input type="number" name="accountNo" class="form-control input-sm" required></td>
        ...
        <tr>
          <td colspan="4">
            <button type="submit" name="saveAccount" class="btn btn-primary btn-sm">Create New Account</button>
