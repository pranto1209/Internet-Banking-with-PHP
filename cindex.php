...
<body style="background: url(images/cashier.jpg);background-size: 100%">
    ...
    <p class="card-text"><?php echo $note; ?>
      <form method="POST">
          <div class="alert alert-success w-50 mx-auto">
            ...
            <button type="submit" name="get" class="btn btn-primary btn-bloc btn-sm my-1">Get Account Information</button>
          </div>
      </form>
    </p>
          ...
          { $row2 = $array2->fetch_assoc();
            echo "<div class='row'>
                  ...
                  <div class='col'>
                    ...
                    <input type='text' class='form-control my-1'  value='$row2[balance] BDT' readonly required>
           ...
           $row2 = $array3->fetch_assoc();
            ...
            <div class='row'>
                  ...
                  <div class='col'>
                    ...
                    <input type='number' class='form-control my-1' name='checkno' placeholder='Enter Transaction Number' required>
                    <input type='number' class='form-control my-1' name='amount' placeholder='Enter Amount For Withdraw' max='$row2[balance]' required>
                   <button type='submit' name='withdraw' class='btn btn-primary btn-bloc btn-sm my-1'> Withdraw</button></form><form method='POST'> 
                    <input type='hidden' value='$row2[accountNo]' name='accountNo' class='form-control ' required>
                    <input type='hidden' value='$row2[id]' name='userId' class='form-control ' required>
                   <input type='number' class='form-control my-1' name='checkno' placeholder='Enter Transaction Number' required>
                    <input type='number' class='form-control my-1' name='amount' placeholder='Enter Amount For Deposit'  required>
            ...
            echo "<div class='alert alert-success w-50 mx-auto'>Account Number $_POST[otherNo] Does Not Exist</div>";
        }
  } 
      ?>
  </div>
